...
var smoothscrollingEnabled = parseInt(
  impeka_grve_smoothscroll_data.smoothscrolling
);
    ...
    function e() {
      t(".woocommerce .quantity input[type=number]").each(function () {
        var e = t(this),
          ...
          i = e;
        setTimeout(function () {
          if (0 == i.next(".grve-plus").length) {
            var e = t(
                '<div class="grve-minus grve-qty-btn"></div>'
              ).insertBefore(i),
              v = t('<div class="grve-plus grve-qty-btn"></div>').insertAfter(
                i
              );
            e.on("click", function (t) {
              t.preventDefault();
              var e = "" === i.val() ? 0 : parseInt(i.val(), 10) - r;
              (e = (e = e < 0 ? 0 : e) < a ? a : e), i.val(e).trigger("change");
            }),
              v.on("click", function (t) {
                t.preventDefault();
                var e = "" === i.val() ? 1 : parseInt(i.val(), 10) + r;
                (e = e > n ? n : e), i.val(e).trigger("change");
              });
          }
        }, 10);
      });
  ...
  (g.prototype.initialise = function () {
    ...
    (a.fn[e] = function (b) {
      return this.each(function () {
        a.data(this, "grve_" + e) || a.data(this, "grve_" + e, new g(this, b));
      });
    });
  ...
  document.body.addEventListener("touchstart", (i) => {
    ...
    document.body.addEventListener(
      ...
      (i) => {
        !t ||
          !i.cancelable ||
          Math.abs(i.touches[0].pageX - e) < 8 ||
...
Flickity.prototype.resize = function () {
  this.isAnimating || resize.call(this);
};
...
!(function (e, i) {
        ...
        return (
          ...
          (t = this).each(function (t, e) {
            ...
            i
              ...
              : d(u + " not initialized. Cannot call methods, i.e. " + r);
          }),
          void 0 !== s ? s : t
        );
      }),
  ...
  (function (e, i) {
    ...
    var h = i.console;
    return (
      (o.htmlInit = function (a, u) {
        o.docReady(function () {
          var t = o.toDashed(u),
            n = "data-" + t,
            e = document.querySelectorAll("[" + n + "]"),
            t = document.querySelectorAll(".js-" + t),
            t = o.makeArray(e).concat(o.makeArray(t)),
            s = n + "-options",
            r = i.jQuery;
          t.forEach(function (e) {
            var t,
          ...
          e(this).length &&
            ...
            (function () {
              ...
              (j.scrollBar = j.scrollBar || j.hybrid),
                ...
                j.scrollOverflow
                  ? (he = j.scrollOverflowHandler.init(j))
                  : Qe(),
                Fe(!0),
